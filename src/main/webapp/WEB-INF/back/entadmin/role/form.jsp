...
$(function(){
	...
	$("input[name='perms']").treeDialog({
		url:"/entadmin/role/perms.do",
		values:"${bean.perms}"
	});
	
	$("#btnRemove").click(function(){
		$("#romts").find("option:selected").remove();
	});
/* 	$("#btnAdd").treeRelateDialog({
	 	hander:"romts",
	 	multiple:false,
	 	message:"请选择机构部门",
		selects : [ {
...
<div class="editButtonsArea">
 	<shiro:hasPermission name="admin:role:toAdd">
  ...
  <div class="formAreaContent"><br />
  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
	    ...
	    <td width="35%" colspan="3" valign="top">
	    	<select id="romts" name="romts" style="width:300px;" multiple="multiple">
	    		<c:if test="${operation=='alter'}">
