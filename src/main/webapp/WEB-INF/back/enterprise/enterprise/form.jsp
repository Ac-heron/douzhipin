...
$(function(){
		    ...
		    fieldname : {
		    	validator : function(value, param) {
		    		...
		    		$.ajax({
		    			...
		    			type:"GET",
		    			data:array,
		    			url:"/entadmin/enterprise/unique.do",
		    			dataType:"json",
	...
	$("form").validator([{
		...
		validType:["fieldname['#id','#entCode']"]
	},{
		id:"entName",
		required:true,
...
<div class="areaContent">
	...
	<div class="editButtonsArea">
		<shiro:hasPermission name="enterprise:enterprise:toAdd">
	 	<div class="add"><a href="add.do">新增</a></div>
		</shiro:hasPermission>
		<shiro:hasPermission name="enterprise:enterprise:view">
	 	<div class="look"><a href="view.do?id=${bean.id}">查看</a></div>
		</shiro:hasPermission>
		<shiro:hasPermission name="enterprise:enterprise:remove">
	  ...
	  <div class="formAreaContent"><br />
	  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
	  		<tr>
			    ...
			    <th width="15%">用户编码：</th>
			    <td width="35%" >
			    	<s:input path="entCode" size="20" maxlength="128" />
			    </td>
	  		</tr>
		  	<tr>
			  	<th width="15%">用户名称：</th>
			    <td width="35%" >
			    	<s:input path="entName" size="20" maxlength="128" />
			    </td>
			    <th width="15%">状态：</th>
			    <td width="35%" >
			   ...
			   <%-- 
			    ...
			    <c:if test="${operation=='alter'}">
				    <td style="display:none">
				    	<s:input id="entCode" path="entCode"/>
				    </td>
			    </c:if> --%>
			</tr>
	    </table>
