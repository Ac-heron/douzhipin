...
<div class="areaContent">
  ...
  <div class="listNews">
      ...
      <tr>
	    ...
	    <th><span class="ls-sort" pagesort="userName">用户名称</span></th>
	    <th><span class="ls-sort" pagesort="userCode">用户代码</span></th>
	    <th><span class="ls-sort" pagesort="userCode">用户角色</span></th>
	    <th><span class="ls-sort" pagesort="userType">用户类型</span></th>
	  ...
	  <td align="center" class="listEditTd">
	  	...
	  	<%-- 	<c:choose>
				...
				<shiro:hasPermission name="admin:discCode:toAlter">
	       		<a class="ls-opt" href="/user/entdiskcode/alter.do?id=${bean.discCodeId}">U盾管理</a>
	       		</shiro:hasPermission>
	       		</c:when>
	       		<c:otherwise>
	       		<shiro:hasPermission name="admin:diskCode:toAdd">
	       		<a class="ls-opt" href="/user/entdiskcode/add.do?userId=${bean.id}">发放U盾</a>
	       		</shiro:hasPermission>
	       		</c:otherwise>
       		</c:choose> --%>
	  		<shiro:hasPermission name="user:userBasic:remove">
	    	<a class="ls-opt" href="javascript:$.remove('${bean.id}');">删除</a>
	  		...
	  		<shiro:hasPermission name="user:userBasic:alter">
