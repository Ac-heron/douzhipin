 ...
 * 修改如下
 * 1.汉化
 * 2.添加ID属性，用于数据库字段名称及表单的名称, 
 * 	 在所有注册字段加上name='<%= rf.get(Formbuilder.options.mappings.NAME) %>'
 * 3.待扩展一些基本组件，如时间，kindEditor等
 */
(function() {
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = '标签名称';
...
//============================================================================================
  Formcreat = function(payload){
	  if($.isArray(payload)){
		  console.log("构造表单开始");
		  /*obj = {};
		  var __t, __p = '', __e = _.escape;
		  $.each(payload, function(i, n){
			  //with (obj) {
			  __p += '<div class=\'subtemplate-wrapper\'>\n  <div class=\'cover\'></div>\n  ' +
			  ((__t = ( Formbuilder.templates['view/label']() )) == null ? '' : __t) +
			  '\n\n  ' +
			  ((__t = ( Formbuilder.fields[n.field_type].view() )) == null ? '' : __t) +
			  '\n\n  ' +
			  ((__t = ( Formbuilder.templates['view/description']() )) == null ? '' : __t) +
			  '\n  ' +
			  ((__t = ( Formbuilder.templates['view/duplicate_remove']() )) == null ? '' : __t) +
			  '\n</div>\n';
...
(function() {
  Formbuilder.registerField('date', {
    order: 20,
    view: "<div class='input-line'>\n  <span class='month'>\n    <input type=\"text\" name='<%= rf.get(Formbuilder.options.mappings.NAME) %>_month' />\n    <label>MM</label>\n  </span>\n\n  <span class='above-line'>/</span>\n\n  <span class='day'>\n    <input type=\"text\" name='<%= rf.get(Formbuilder.options.mappings.NAME) %>_day' />\n    <label>DD</label>\n  </span>\n\n  <span class='above-line'>/</span>\n\n  <span class='year'>\n    <input type=\"text\" name='<%= rf.get(Formbuilder.options.mappings.NAME) %>_year' />\n    <label>YYYY</label>\n  </span>\n</div>",
    edit: "",
...
(function() {
  Formbuilder.registerField('dropdown', {
    order: 24,
    view: "<select name='<%= rf.get(Formbuilder.options.mappings.NAME) %>'>\n  <% if (rf.get(Formbuilder.options.mappings.INCLUDE_BLANK)) { %>\n    <option value=''></option>\n  <% } %>\n\n  <% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n    <option <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'selected' %>>\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </option>\n  <% } %>\n</select>",
...
(function() {
  Formbuilder.registerField('email', {
    order: 40,
    view: "<input type='text' name='<%= rf.get(Formbuilder.options.mappings.NAME) %>' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' id='<%= rf.get(Formbuilder.options.mappings.NAME) %>' name='<%= rf.get(Formbuilder.options.mappings.NAME) %>'/>",
    edit: "",
...
(function() {
  Formbuilder.registerField('number', {
    order: 30,
    view: "<input type='text' name='<%= rf.get(Formbuilder.options.mappings.NAME) %>' />\n<% if (units = rf.get(Formbuilder.options.mappings.UNITS)) { %>\n  <%= units %>\n<% } %>",
...
(function() {
  Formbuilder.registerField('paragraph', {
    order: 5,
    view: "<textarea name='<%= rf.get(Formbuilder.options.mappings.NAME) %>' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>'></textarea>",
...
(function() {
  Formbuilder.registerField('price', {
    order: 45,
    view: "<div class='input-line'>\n  <span class='above-line'>$</span>\n  <span class='dolars'>\n    <input type='text' name='<%= rf.get(Formbuilder.options.mappings.NAME) %>_dolars' />\n    <label>Dollars</label>\n  </span>\n  <span class='above-line'>.</span>\n  <span class='cents'>\n    <input type='text' name='<%= rf.get(Formbuilder.options.mappings.NAME) %>_cents' />\n    <label>Cents</label>\n  </span>\n</div>",
    edit: "",
...
(function() {
  Formbuilder.registerField('radio', {
    order: 15,
    view: "<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div>\n    <label class='fb-option'>\n      <input type='radio' name='<%= rf.get(Formbuilder.options.mappings.NAME) %>' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class='other-option'>\n    <label class='fb-option'>\n      <input type='radio' name='<%= rf.get(Formbuilder.options.mappings.NAME) %>'/>\n      Other\n    </label>\n\n    <input type='text' />\n  </div>\n<% } %>",
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
...
(function() {
  Formbuilder.registerField('section_break', {
    ...
    edit: "<div class='fb-edit-section-header'>字段标签</div>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.LABEL %>' />\n<textarea data-rv-input='model.<%= Formbuilder.options.mappings.DESCRIPTION %>'\n  placeholder='这里添加字段标签描述'></textarea>",
    addButton: "<span class='symbol'><span class='fa fa-minus'></span></span> 分割符"
  });
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>字段标签</div>\n\n<div class=\'fb-common-wrapper\'>\n  <div class=\'fb-label-description\'>\n    ' +
...
//============================================================================================
__p += Formbuilder.templates['edit/field_name'](); // NAME 用来定义ID
//============================================================================================
}
return __p
};
// 自定义的ID
//============================================================================================
this["Formbuilder"]["templates"]["edit/field_name"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>数据库字段名称</div>\n<label>\n  <input type=\'text\' placeholder=\'保持唯一\' data-rv-input=\'model.' +
...
with (obj) {
__p +=
((__t = ( Formbuilder.templates['partials/save_table']() )) == null ? '' : __t) +
'\n' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>添加新字段</a></li>\n    <li><a data-target=\'#editField\'>编辑字段</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    ' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-right\'>\n  <div class=\'fb-no-response-fields\'>字段未设置</div>\n  <div class=\'fb-response-fields\'></div>\n</div>\n';

}
return __p
};

this["Formbuilder"]["templates"]["partials/save_table"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-save-napper\'>\n <input type="text" id="tbName" placeholder="数据库表名"> <input type="text" id="tbComment" placeholder="表单名称"> \n</div>';
}
return __p
};
